...
export const ENGINEERING_BASIS = [
  ...
  { parameter: 'Main steam pressure', value: 'CEA minimum threshold: 247 kg/cm\u00b2 (242.2 bar) at turbine throttle, indicative 256 kg/cm\u00b2 (251.1 bar). See Plant Setup \u2192 ultra-supercritical tier for this app\u2019s own default (290 bar), which exceeds the CEA minimum as many real USC projects do.', unit: 'bar', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.2(iii)' },
  { parameter: 'Main steam temperature', value: 'CEA minimum threshold: HP turbine inlet minimum 565\u00b0C, indicative 568\u00b0C. See Plant Setup \u2192 ultra-supercritical tier for this app\u2019s own default (600\u00b0C), which exceeds the CEA minimum as many real USC projects do.', unit: '\u00b0C', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.2(ii)(a)' },
  { parameter: 'Reheat steam temperature', value: 'CEA minimum threshold: IP turbine inlet minimum 593\u00b0C, indicative 596\u00b0C. See Plant Setup \u2192 ultra-supercritical tier for this app\u2019s own default (620\u00b0C).', unit: '\u00b0C', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.2(ii)(b)' },
  { parameter: 'Feedwater temperature at economizer inlet', value: '287.5 \u00b1 2.5\u00b0C (or as optimized by the turbine-generator supplier) \u2014 achieved via HP turbine extraction (adopted in preference to the older CRH-extraction design, which typically limits feedwater temperature to ~255\u00b0C)', unit: '\u00b0C', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.2(iv) and Cl. 1.2.4' },
  { parameter: 'Main steam flow', value: 'VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT \u2014 CEA sizing rule: 1.02 \u00d7 (turbine VWO steam flow + unit continuous auxiliary steam requirement at TMCR), rounded up to the next integer divisible by 5', unit: 't/h', required: true, source: 'Boiler Thermal Design Data Sheet; sizing rule per CEA Standard Technical Features of BTG System (July 2013), Cl. 6.2(i)' },
  { parameter: 'Reheat flow', value: 'VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT (reheat line + reheater pressure drop shall not exceed 10% of HP turbine exhaust pressure at any operating condition up to 100% BMCR, per CEA Std)', unit: 't/h', required: true, source: 'Boiler Thermal Design Data Sheet; CEA Standard Technical Features of BTG System (July 2013), Cl. 6.2 Note (a)' },
  { parameter: 'Steam generator control range', value: '50% TMCR to 100% BMCR (automatic SH/RH outlet steam temperature control range, maintained within \u00b15\u00b0C of rated value)', unit: '% TMCR\u2013BMCR', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.2(v) and Cl. 6.4.7' },
  { parameter: 'Minimum load without oil support for flame stabilization', value: '40% BMCR (with any combination of mills/adjacent mills in service, for the specified coal range)', unit: '% BMCR', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.4.2' },
  { parameter: 'Turbine configuration', value: 'Typical for this class: single-shaft, tandem-compound, condensing steam turbine, single reheat, with HP-IP combined or separate casings plus one or two LP casings (double-flow exhaust). VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT for the specific arrangement offered.', unit: '', required: true, source: 'Turbine General Arrangement Drawing; typical configuration per CEA Standard Technical Features of BTG System (July 2013), Ch. 12 and industry literature for 660 MW-class USC turbines' },
  ...
  { parameter: 'Boiler feed pump configuration', value: 'CEA-adopted standard practice: 2 \u00d7 50% turbine-driven BFP (TDBFP) + 1 \u00d7 50% motor-driven BFP (MDBFP), for spares interchangeability and inventory commonality. An alternate 3 \u00d7 50% MDBFP arrangement is also acceptable but increases auxiliary power consumption.', unit: '', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 1.2.5' },
  { parameter: 'ID fan type', value: 'Axial, variable-pitch (radial fans of sufficient capacity for 660/800 MW class are generally not available; axial variable-pitch fans are also more efficient at this size)', unit: '', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 1.2.8' },
  ...
  { parameter: 'Governor droop', value: '3 to 6%', unit: '%', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 3.13' },
  { parameter: 'Grid frequency operating range', value: '47.5\u201351.5 Hz (Indian grid \u2014 confirm against the actual project\u2019s grid code, since this range is not universal)', unit: 'Hz', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 3.11' },
  ...
  { parameter: 'Design coal / worst coal', value: 'VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT (design/worst/best coal characteristics). Blended coal with up to 30% imported coal by weight is a standard design allowance for indigenous-coal plants of this class.', unit: '', required: true, source: 'Coal Quality Design Basis; blending allowance per CEA Standard Technical Features of BTG System (July 2013), Cl. 6.1.3' },
  { parameter: 'Excess air / flue gas temperature at economizer & APH outlet', value: 'Minimum 20% excess air at economizer outlet at 100% TMCR; corrected flue gas temperature at APH outlet of 125\u00b0C or the OEM\u2019s predicted value (considering acid dew point), whichever is higher \u2014 evaluated at 27\u00b0C ambient, 60% RH per the CEA guarantee test basis', unit: '', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 6.4.1 and Cl. 5.5.1' },
  { parameter: 'Ambient design conditions', value: 'VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT (site-specific); CEA guarantee-test reference ambient is 27\u00b0C dry bulb, 60% relative humidity \u2014 a test basis, not a substitute for the actual site design basis', unit: '', required: true, source: 'Project Site Design Basis; CEA test-basis reference per Cl. 5.5.1(c)' },
  { parameter: 'Minimum stable generation', value: 'VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT (once-through boilers typically ~30\u201340% MCR for the separator/circulation-mode to once-through transition)', unit: '% MCR', required: true, source: 'Boiler/Turbine Operating Range Data Sheet' },
  ...
  { parameter: 'Design ramp rates', value: 'CEA minimum design basis: step load change \u00b110% (minimum), ramp rate \u00b13% per minute (minimum) above 30% load. VALUE REQUIRED FROM OEM / APPROVED DESIGN DOCUMENT for the specific unit\u2019s achievable rate, which may exceed this minimum.', unit: '% MCR/min', required: true, source: 'Unit Operating Procedures / C&E; minimum basis per CEA Standard Technical Features of BTG System (July 2013), Cl. 6.4.6(ii)' },
  { parameter: 'Design life', value: 'Minimum 25 years, with expected steam generator start counts over the design life of approximately: 150 cold starts (after shutdown exceeding 72 h), 1000 warm starts (shutdown 10\u201372 h), 4000 hot starts (shutdown under 10 h)', unit: 'years', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 2.1 and Cl. 6.4.3(i)' },
  { parameter: 'Turbine cycle heat rate (regulatory maximum, India)', value: 'Maximum 1850 kcal/kWh with turbine-driven BFP, or 1810 kcal/kWh with motor-driven BFP, per CEA (Technical Standards for Construction of Electrical Plants and Electric Lines) Regulations, 2010 \u2014 an Indian regulatory ceiling, not a universal design target', unit: 'kcal/kWh', required: false, source: 'CEA Standard Technical Features of BTG System for Supercritical 660/800 MW Thermal Units (July 2013), Cl. 1.1, citing CEA Regulations 2010' },
];
